...
d1610
  = coe
      ...
      (coe
         MAlonzo.Code.Algebra.Structures.C19417 (coe d1482) (coe d1600)
         (coe d1548))
      (coe d1512)
name1612 = "Data.Bool.Properties.∨-∧-isCommutativeSemiring"
d1612 :: MAlonzo.Code.Algebra.Structures.T1280
d1612
  = coe MAlonzo.Code.Algebra.Structures.C23291 (coe d1610) erased
name1614 = "Data.Bool.Properties.∨-∧-commutativeSemiring"
d1614 :: MAlonzo.Code.Algebra.Bundles.T1818
d1614
  = coe
      MAlonzo.Code.Algebra.Bundles.C20447 MAlonzo.Code.Data.Bool.Base.d30
...
d1616
  = coe
      MAlonzo.Code.Algebra.Structures.C21445
      (coe
         MAlonzo.Code.Algebra.Structures.C19417 (coe d1602) (coe d1480)
         (coe d1568))
      (coe d1446)
name1618 = "Data.Bool.Properties.∧-∨-isCommutativeSemiring"
d1618 :: MAlonzo.Code.Algebra.Structures.T1280
d1618
  = coe MAlonzo.Code.Algebra.Structures.C23291 (coe d1616) erased
name1620 = "Data.Bool.Properties.∧-∨-commutativeSemiring"
d1620 :: MAlonzo.Code.Algebra.Bundles.T1818
d1620
  = coe
      MAlonzo.Code.Algebra.Bundles.C20447 MAlonzo.Code.Data.Bool.Base.d24
...
d1624
  = coe
      MAlonzo.Code.Algebra.Bundles.C10765 MAlonzo.Code.Data.Bool.Base.d30
...
d1626
  = coe MAlonzo.Code.Algebra.Structures.C14327 (coe d1622) erased
name1628 = "Data.Bool.Properties.∨-∧-distributiveLattice"
d1628 :: MAlonzo.Code.Algebra.Bundles.T1058
d1628
  = coe
      MAlonzo.Code.Algebra.Bundles.C11691 MAlonzo.Code.Data.Bool.Base.d30
...
d1630
  = coe
      MAlonzo.Code.Algebra.Structures.C31531 (coe d1626) erased erased
      erased
name1632 = "Data.Bool.Properties.∨-∧-booleanAlgebra"
d1632 :: MAlonzo.Code.Algebra.Bundles.T2410
d1632
  = coe
      MAlonzo.Code.Algebra.Bundles.C27221 MAlonzo.Code.Data.Bool.Base.d30
...
d2026 v0
  = if coe v0
      then coe
             ...
             (let v1 = coe MAlonzo.Code.Agda.Builtin.Unit.C8 in
              coe (\ v2 -> v1))
             ...
             then coe
                    ...
                    (let v2
                           = coe
                               ...
                               (coe MAlonzo.Code.Agda.Builtin.Unit.C8) in
                     coe (\ v3 -> v2))
                    (let v2 = coe MAlonzo.Code.Agda.Builtin.Unit.C8 in
                     coe (\ v3 -> v2))
             else coe
                    MAlonzo.Code.Function.Equivalence.du56 erased
