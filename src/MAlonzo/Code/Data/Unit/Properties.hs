...
d22
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C4935 (coe d18) erased
name24 = "Data.Unit.Properties.≡-isTotalOrder"
d24 :: MAlonzo.Code.Relation.Binary.Structures.T340
d24
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C11755 (coe d22)
      (\ v0 v1 -> coe du12)
name26 = "Data.Unit.Properties.≡-isDecTotalOrder"
d26 :: MAlonzo.Code.Relation.Binary.Structures.T388
d26
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C12829 (coe d24)
      (\ v0 v1 -> coe du6) (\ v0 v1 -> coe du6)
...
d44
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C4935 (coe d42) erased
name46 = "Data.Unit.Properties.≤-isTotalOrder"
d46 :: MAlonzo.Code.Relation.Binary.Structures.T340
d46
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C11755 (coe d44)
      (\ v0 v1 -> coe du38)
name48 = "Data.Unit.Properties.≤-isDecTotalOrder"
d48 :: MAlonzo.Code.Relation.Binary.Structures.T388
d48
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C12829 (coe d46)
      (\ v0 v1 -> coe du6) (\ v0 v1 -> coe du40)
