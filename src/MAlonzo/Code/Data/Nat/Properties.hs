...
d1380
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C1575
...
d1482 = coe MAlonzo.Code.Function.Base.du74 (coe d1476)
name1484 = "Data.Nat.Properties.≤-isPreorder"
d1484 :: MAlonzo.Code.Relation.Binary.Structures.T70
d1484
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C2159
      (coe MAlonzo.Code.Relation.Binary.PropositionalEquality.du66)
...
du1564 v0 v1
  = case coe v0 of
      0 -> coe MAlonzo.Code.Relation.Nullary.Negation.du26 (coe ())
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             0 -> coe
                    MAlonzo.Code.Data.Nat.Base.C18 (coe MAlonzo.Code.Data.Nat.Base.C10)
...
d1576 v0 v1
  = coe
      MAlonzo.Code.Function.Base.du52 (coe (\ v2 -> coe du1532 (coe v0)))
      (\ v2 -> coe du1564 (coe v0) (coe v1))
...
du1594 v0 v1
  = case coe v0 of
      0 -> coe
             seq (coe v1)
             (coe MAlonzo.Code.Relation.Nullary.Negation.du26 (coe ()))
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             MAlonzo.Code.Data.Nat.Base.C10
               -> coe
...
d1630 = coe MAlonzo.Code.Function.Base.du74 (coe d1608)
...
d1702 = coe MAlonzo.Code.Function.Base.du74 (coe d1696)
...
d1712
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C7263
      (coe MAlonzo.Code.Relation.Binary.PropositionalEquality.du66)
...
d1714
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C14147
      (coe MAlonzo.Code.Relation.Binary.PropositionalEquality.du66)
...
d1824
  = coe
      MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du346
      (coe d1484)
...
d1856 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T12 ->
  MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.T70
d1856 v0 v1 v2 v3 v4
  = coe
      MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du294 v3 v4
...
d1858 ::
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T12 ->
  MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.T70
d1858 v0 v1 v2 v3 v4
  = coe MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du326 v3
...
d2084 ::
  ...
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T6 -> MAlonzo.Code.Data.Nat.Base.T6
d2084 v0 v1 v2 = du2084 v0
du2084 ::
  Integer ->
  MAlonzo.Code.Data.Nat.Base.T6 -> MAlonzo.Code.Data.Nat.Base.T6
du2084 v0
  = coe
      MAlonzo.Code.Function.Base.du52 (coe (\ v1 -> coe du2064 (coe v0)))
      (coe (\ v1 -> v1))
...
d2102
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.C32 (\ v0 v1 v2 -> coe du2084 v0)
...
d2444
  = coe
      MAlonzo.Code.Algebra.Structures.C21445
      (coe
         MAlonzo.Code.Algebra.Structures.C19417 (coe d1986) (coe d2440)
         (coe d2418))
      (coe d2390)
name2446 = "Data.Nat.Properties.*-+-isCommutativeSemiring"
d2446 :: MAlonzo.Code.Algebra.Structures.T1280
d2446
  = coe MAlonzo.Code.Algebra.Structures.C23291 (coe d2444) erased
...
d2462
  = coe
      MAlonzo.Code.Algebra.Bundles.C18611 addInt mulInt (0 :: Integer)
      (1 :: Integer) d2444
name2464 = "Data.Nat.Properties.*-+-commutativeSemiring"
d2464 :: MAlonzo.Code.Algebra.Bundles.T1818
d2464
  = coe
      MAlonzo.Code.Algebra.Bundles.C20447 addInt mulInt (0 :: Integer)
      (1 :: Integer) d2446
...
d2640 v0 v1 v2
  = coe
      ...
      (coe
         MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du294
         (coe
            MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du228
            ...
            (coe
               MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du346
               (coe d1484) (coe mulInt (coe v0) (coe v1)))
...
du2736
  = coe MAlonzo.Code.Algebra.Morphism.C1527 (coe du2728) erased
  ...
  = case coe v0 of
      ...
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             ...
             _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe
                    MAlonzo.Code.Function.Base.du90
                    (coe MAlonzo.Code.Data.Nat.Base.C18) (coe d2940 (coe v2) (coe v3))
...
d3422
  = coe MAlonzo.Code.Algebra.Structures.C14327 (coe d3420) erased
...
d3432
  = coe
      MAlonzo.Code.Algebra.Bundles.C15577 MAlonzo.Code.Data.Nat.Base.d74
...
d3434
  = coe
      MAlonzo.Code.Algebra.Bundles.C10765 MAlonzo.Code.Data.Nat.Base.d84
...
d3436
  = coe
      MAlonzo.Code.Algebra.Bundles.C11691 MAlonzo.Code.Data.Nat.Base.d84
      ...
      _ -> let v2 = subInt (coe v0) (coe (1 :: Integer)) in
           case coe v1 of
             ...
             _ -> let v3 = subInt (coe v1) (coe (1 :: Integer)) in
                  coe
                    MAlonzo.Code.Function.Base.du90
                    (coe MAlonzo.Code.Data.Nat.Base.C18) (coe d3460 (coe v2) (coe v3))
             ...
             (coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du346
                         (coe d1484) (coe MAlonzo.Code.Agda.Builtin.Nat.d22 v1 v0))
                      erased)
                   erased))
      MAlonzo.Code.Data.Sum.Base.C42 v3
        -> coe
...
d4740 = coe MAlonzo.Code.Function.Base.du74 (coe d4728)
name4742 = "Data.Nat.Properties._>′?_"
d4742 :: Integer -> Integer -> MAlonzo.Code.Relation.Nullary.T32
d4742 = coe MAlonzo.Code.Function.Base.du74 (coe d4734)
...
d4822 v0 v1
  = coe
      MAlonzo.Code.Function.Base.du52
      (coe
         (\ v2 v3 ->
            coe
              MAlonzo.Code.Data.Nat.Base.C170
...
d4838 = coe MAlonzo.Code.Function.Base.du74 (coe d4830)
name4840 = "Data.Nat.Properties._>″?_"
d4840 :: Integer -> Integer -> MAlonzo.Code.Relation.Nullary.T32
d4840 = coe MAlonzo.Code.Function.Base.du74 (coe d4824)
             ...
             (coe
                ...
                (coe
                   ...
                   (coe
                      ...
                      (coe
                         MAlonzo.Code.Relation.Binary.Reasoning.Base.Triple.du346
                         (coe d1484) (coe MAlonzo.Code.Agda.Builtin.Nat.d22 v0 v1))
                      erased)
                   erased))
      _ -> MAlonzo.RTE.mazUnreachableError
