...
d34 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> T22 -> Bool
...
d36 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> T22 -> Bool
d36 v0 v1 = du36
du36 :: T22 -> Bool
du36
  = coe
      MAlonzo.Code.Function.Base.du52
      (coe (\ v0 -> MAlonzo.Code.Data.Bool.Base.d22)) (coe du34)
...
d64 ::
  MAlonzo.Code.Agda.Primitive.T14 -> () -> AgdaAny -> T22 -> AgdaAny
d64 v0 v1 = du64
du64 :: AgdaAny -> T22 -> AgdaAny
du64 = coe du62 (\ v0 -> v0)
name74 = "Data.Maybe.Base._.From-just"
d74 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> T22 -> ()
d74 = erased
...
du82 v0
  = coe
      du50
      (coe
         MAlonzo.Code.Function.Base.du52 (coe (\ v1 -> coe C30)) (coe v0))
      (coe C26)
name86 = "Data.Maybe.Base.ap"
d86 ::
  MAlonzo.Code.Agda.Primitive.T14 ->
  () -> MAlonzo.Code.Agda.Primitive.T14 -> () -> T22 -> T22 -> T22
...
d98 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> T22 -> T22 -> T22
