...
du54 = coe MAlonzo.Code.Data.Sum.Base.du66 (coe C48) (coe C50)
...
du120 v0 v1 v2
  = coe
      du92 (coe MAlonzo.Code.Function.Base.du74 (coe v2) (coe v1))
      (coe v2 v0) (coe v2)
name128 = "Data.These.Base.swap"
d128 ::
  MAlonzo.Code.Agda.Primitive.T14 ->
  () -> MAlonzo.Code.Agda.Primitive.T14 -> () -> T38 -> T38
d128 v0 v1 v2 v3 = du128
du128 :: T38 -> T38
du128
  = coe
      du92 (coe C50) (coe C48)
      (coe MAlonzo.Code.Function.Base.du74 (coe C52))
...
du130 v0 v1 v2 v3
  = case coe v2 of
      C48 v4
        -> case coe v3 of
             C48 v5 -> coe C48 (coe v0 (coe C52 (coe v4) (coe v5)))
             C50 v5 -> coe C52 (coe v0 v2) (coe v1 v3)
             C52 v5 v6
               -> coe
                    C52 (coe v0 (coe C52 (coe v4) (coe v5)))
                    (coe v1 (coe C50 (coe v6)))
             _ -> MAlonzo.RTE.mazUnreachableError
      C50 v4
        -> case coe v3 of
             C48 v5
               -> coe C52 (coe v0 (coe C50 (coe v5))) (coe v1 (coe C48 (coe v4)))
             C50 v5 -> coe C50 (coe v1 (coe C52 (coe v4) (coe v5)))
             C52 v5 v6
               -> coe
                    C52 (coe v0 (coe C50 (coe v5)))
                    (coe v1 (coe C52 (coe v4) (coe v6)))
             _ -> MAlonzo.RTE.mazUnreachableError
      C52 v4 v5
        -> case coe v3 of
             C48 v6
               -> coe
                    C52 (coe v0 (coe C52 (coe v4) (coe v6)))
                    (coe v1 (coe C48 (coe v5)))
             C50 v6
               -> coe
                    C52 (coe v0 (coe C48 (coe v4)))
                    (coe v1 (coe C52 (coe v5) (coe v6)))
             C52 v6 v7
               -> coe
                    C52 (coe v0 (coe C52 (coe v4) (coe v6)))
                    (coe v1 (coe C52 (coe v5) (coe v7)))
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
d216 ::
  ...
  () ->
  MAlonzo.Code.Agda.Primitive.T14 ->
  () -> MAlonzo.Code.Agda.Primitive.T14 -> () -> T38 -> T38 -> T38
