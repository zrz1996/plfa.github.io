...
d262 ::
  ...
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14
d262 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 = du262 v8 v9
du262 ::
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  (AgdaAny -> AgdaAny -> AgdaAny) ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14
du262 v0 v1
  = coe
      MAlonzo.Code.Function.Base.du220 (coe v0)
      (coe MAlonzo.Code.Agda.Builtin.Sigma.C32) (coe v1)
