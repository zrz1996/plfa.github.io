...
data T114
  = C2133 T90 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name122
...
data T280 = C4281 T258 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name288
...
data T312
  = C4999 T280 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name320
...
du344 :: T312 -> T114
du344 v0
  = coe C2133 (coe du304 (coe d320 (coe v0))) (coe d322 (coe v0))
name348
...
data T542 = C7465 T258 (AgdaAny -> AgdaAny)
name550
...
data T568 = C7831 T542 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name576
...
du596 :: T568 -> T280
du596 v0
  = coe C4281 (coe d550 (coe d576 (coe v0))) (coe d578 (coe v0))
name600
...
data T604
  = C8613 T568 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name612
...
du640 :: T604 -> T312
du640 v0
  = coe C4999 (coe du596 (coe d612 (coe v0))) (coe d614 (coe v0))
name644
...
data T918 = C11799 T876 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name926
...
du960 :: T918 -> T568
du960 v0
  = coe C7831 (coe d884 (coe d926 (coe v0))) (coe d928 (coe v0))
name962
...
du962 :: T918 -> T280
du962 v0
  = coe C4281 (coe d886 (coe d926 (coe v0))) (coe d928 (coe v0))
name966
...
data T970
  = C13039 T918 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name978
...
du1022 :: T970 -> T604
du1022 v0
  = coe C8613 (coe du960 (coe d978 (coe v0))) (coe d980 (coe v0))
name1024
...
du1024 :: T970 -> T312
du1024 v0
  = coe C4999 (coe du962 (coe d978 (coe v0))) (coe d980 (coe v0))
name1028
