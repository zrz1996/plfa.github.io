         ...
         (coe
            ...
            (let v1 = MAlonzo.Code.Algebra.Bundles.d806 (coe v0) in
             coe
               ...
               (MAlonzo.Code.Algebra.Structures.d542 (coe v1))
               (coe
                  MAlonzo.Code.Algebra.Bundles.d804 v0
                  (MAlonzo.Code.Algebra.Bundles.d802 (coe v0))))))
            ...
            (coe
               ...
               (let v3 = MAlonzo.Code.Algebra.Bundles.d806 (coe v0) in
                ...
                coe
                  ...
                  (coe MAlonzo.Code.Algebra.Structures.d124 (coe v5)) (coe v1)
                  (coe MAlonzo.Code.Algebra.Bundles.d802 (coe v0))
                  (coe
                     MAlonzo.Code.Algebra.Bundles.d800 v0 v2
                     (coe MAlonzo.Code.Algebra.Bundles.d804 v0 v2)))
               (coe
                  ...
                  (coe
                     ...
                     (MAlonzo.Code.Algebra.Bundles.d806 (coe v0)) v2))))
         (coe
            MAlonzo.Code.Relation.Binary.Structures.d36
            (MAlonzo.Code.Algebra.Structures.d88
               (coe
            ...
            (let v3 = MAlonzo.Code.Algebra.Bundles.d806 (coe v0) in
             coe
               MAlonzo.Code.Algebra.Structures.du356
               (MAlonzo.Code.Algebra.Structures.d542 (coe v3)) v1)))
         ...
         (coe
            ...
            (coe
               ...
               (coe
                  ...
                  (coe
                     MAlonzo.Code.Algebra.Structures.du588
                     (MAlonzo.Code.Algebra.Bundles.d806 (coe v0)) v1))))
         (coe
            MAlonzo.Code.Relation.Binary.Structures.d36
            (MAlonzo.Code.Algebra.Structures.d88
               (coe
            ...
            (let v3 = MAlonzo.Code.Algebra.Bundles.d806 (coe v0) in
             coe
               ...
               (MAlonzo.Code.Algebra.Structures.d542 (coe v3)) v2)))
  ...
  = coe
      ...
      (coe
         ...
         (let v2 = MAlonzo.Code.Algebra.Bundles.d806 (coe v0) in
          coe
            MAlonzo.Code.Algebra.Structures.du356
            (MAlonzo.Code.Algebra.Structures.d542 (coe v2))
            (coe
               MAlonzo.Code.Algebra.Bundles.d804 v0
               (coe MAlonzo.Code.Algebra.Bundles.d804 v0 v1))))
