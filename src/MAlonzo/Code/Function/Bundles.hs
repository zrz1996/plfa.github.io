...
d54 ::
  ...
  MAlonzo.Code.Relation.Binary.Bundles.T44 ->
  MAlonzo.Code.Relation.Binary.Bundles.T44 ->
  MAlonzo.Code.Agda.Primitive.T14 -> () -> (AgdaAny -> AgdaAny) -> ()
d54 = erased
...
du796 v0
  = coe
      C5633 (coe d786 (coe v0)) (coe d788 (coe v0)) (coe du792 (coe v0))
...
du798 v0
  = coe
      C7071 (coe d786 (coe v0)) (coe d788 (coe v0)) (coe du794 (coe v0))
...
data T860
  = C10839 (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du952 v0 v1 v2
  = coe
      MAlonzo.Code.Function.Structures.C7257
...
du954 v0
  = coe
      C10839 (coe d890 (coe v0)) (coe d892 (coe v0)) (coe d894 (coe v0))
      (coe d896 (coe v0))
name956 = "Function.Bundles._.RightInverse"
d956 a0 a1 a2 a3 a4 a5 = ()
data T956
  = C13737 (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
...
du980 v0 v1 v2
  = coe
      MAlonzo.Code.Function.Structures.C9009
...
du982 v0
  = coe
      C10839 (coe d968 (coe v0)) (coe d970 (coe v0)) (coe d972 (coe v0))
      (coe d974 (coe v0))
name984 = "Function.Bundles._.BiEquivalence"
d984 a0 a1 a2 a3 a4 a5 = ()
data T984
  = C15655 (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du1046 v0 v1 v2
  = coe
      MAlonzo.Code.Function.Structures.C13461
...
du1076 v0
  = coe
      C11595 (coe d1062 (coe v0)) (coe d1064 (coe v0))
      (coe d1066 (coe v0)) (coe d1068 (coe v0)) (coe du1072 (coe v0))
...
du1078 v0
  = coe
      C13737 (coe d1062 (coe v0)) (coe d1064 (coe v0))
      (coe d1066 (coe v0)) (coe d1068 (coe v0)) (coe du1074 (coe v0))
...
du1088 v0 v1 v2
  = coe
      MAlonzo.Code.Function.Structures.C15081
...
du1226 ::
  (AgdaAny -> AgdaAny) ->
  (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14) -> T710
du1226 v0 v1 = coe C7071 (coe v0) erased (coe v1)
...
du1234 ::
  (AgdaAny -> AgdaAny) -> MAlonzo.Code.Agda.Builtin.Sigma.T14 -> T778
du1234 v0 v1 = coe C8355 (coe v0) erased (coe v1)
...
du1244 v0 v1 = coe C10839 (coe v0) (coe v1) erased erased
...
du1254 ::
  ...
  (AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12) -> T878
du1254 v0 v1 v2
  = coe C11595 (coe v0) (coe v1) erased erased (coe v2)
...
du1266 ::
  ...
  (AgdaAny -> MAlonzo.Code.Agda.Builtin.Equality.T12) -> T956
du1266 v0 v1 v2
  = coe C13737 (coe v0) (coe v1) erased erased (coe v2)
...
du1280 v0 v1 v2 v3 v4
  = coe
      C16939 (coe v0) (coe v1) (coe v2) erased erased erased (coe v3)
      (coe v4)
...
du1296 ::
  ...
  MAlonzo.Code.Agda.Builtin.Sigma.T14 -> T1050
du1296 v0 v1 v2
  = coe C18847 (coe v0) (coe v1) erased erased (coe v2)
