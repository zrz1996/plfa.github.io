...
data T552
  = C13461 T22 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny) (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
           (AgdaAny -> AgdaAny)
...
data T640 = C15081 T312 (AgdaAny -> AgdaAny)
...
du716 v0
  = coe
      C9009 (coe d324 (coe d650 (coe v0))) (coe d326 (coe d650 (coe v0)))
      (coe d652 (coe v0))
