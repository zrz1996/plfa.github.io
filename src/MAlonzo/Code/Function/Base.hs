...
d24 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> AgdaAny -> AgdaAny
...
du104 v0 v1
  = coe
      du74 (coe MAlonzo.Code.Agda.Builtin.Strict.d18 v0 v1 erased erased)
...
d184 ::
  ...
  () ->
  (AgdaAny -> AgdaAny) -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny
d184 v0 v1 v2 v3 v4 v5 v6 v7 = du184 v6 v7
du184 ::
  (AgdaAny -> AgdaAny) -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny
du184 v0 v1 = coe du52 (coe (\ v2 -> v0)) (coe v1)
...
d192 ::
  ...
  MAlonzo.Code.Agda.Primitive.T14 ->
  () -> (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny
d192 v0 v1 v2 v3 = du192 v0 v2
du192 ::
  MAlonzo.Code.Agda.Primitive.T14 ->
  MAlonzo.Code.Agda.Primitive.T14 ->
  (AgdaAny -> AgdaAny) -> AgdaAny -> AgdaAny
du192 v0 v1 = coe du104 (coe v0) (coe v1)
...
du196 v0 v1 = coe du176 (coe v0) (coe v1)
...
d234 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> AgdaAny -> AgdaAny
d234 v0 v1 v2 = du234 v2
du234 :: AgdaAny -> AgdaAny
du234 v0 = coe v0
name242 = "Function.Base.typeOf"
d242 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> AgdaAny -> ()
d242 = erased
name248 = "Function.Base.it"
d248 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> AgdaAny -> AgdaAny
