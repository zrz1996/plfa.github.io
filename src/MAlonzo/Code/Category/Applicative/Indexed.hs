...
du84 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (coe du72 (coe v0) (coe v1) (coe v2)) v5 v6
...
du108 v0 v1 v2 v3 v4 v5
  = coe
      ...
      (coe
         ...
         (coe MAlonzo.Code.Function.Base.du74 (coe (\ v6 v7 -> v6))) v4)
      v5
...
d156 a0 a1 a2 a3 = ()
data T156 = C7835 T38 (() -> AgdaAny -> AgdaAny -> AgdaAny)
name170
  ...
  = let v1 = d170 (coe v0) in
    coe
      (\ v2 v3 v4 v5 v6 v7 ->
         coe
           MAlonzo.Code.Category.Functor.du32
           (coe du72 (coe v1) (coe v2) (coe v3)) v6 v7)
name182
  ...
  = let v1 = d224 (coe v0) in
    ...
    coe
      (\ v3 v4 v5 v6 v7 v8 ->
         coe
           MAlonzo.Code.Category.Functor.du32
           (coe du72 (coe v2) (coe v3) (coe v4)) v7 v8)
...
newtype T274
  = C13167 (() -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
