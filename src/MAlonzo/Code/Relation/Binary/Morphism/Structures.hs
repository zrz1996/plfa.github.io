...
data T136
  = C3697 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name152
...
data T180
  = C6249 T136 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
          (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
name198
...
data T236
  = C9835 T180 (AgdaAny -> MAlonzo.Code.Agda.Builtin.Sigma.T14)
name252
