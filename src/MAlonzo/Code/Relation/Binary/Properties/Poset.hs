...
du150 v0
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C4935
      (coe
         MAlonzo.Code.Relation.Binary.Properties.Preorder.du64
         (coe MAlonzo.Code.Relation.Binary.Bundles.du248 (coe v0)))
      (coe
         (\ v1 v2 ->
            coe
              MAlonzo.Code.Function.Base.du74
              (coe
                 MAlonzo.Code.Relation.Binary.Structures.d128
                 (MAlonzo.Code.Relation.Binary.Bundles.d226 (coe v0)) v1 v2)))
...
d194 ::
  ...
  (AgdaAny -> MAlonzo.Code.Data.Empty.T4) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T14
d194 v0 v1 v2 v3 v4 v5 = du194
du194 ::
  AgdaAny ->
  (AgdaAny -> MAlonzo.Code.Data.Empty.T4) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T14
du194
  = coe MAlonzo.Code.Relation.Binary.Construct.NonStrictToStrict.du44
