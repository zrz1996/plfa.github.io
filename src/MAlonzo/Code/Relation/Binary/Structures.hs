...
data T118
  = C4935 T70 (AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
du200 v0
  = coe
      C1575 (coe d80 (coe d126 (coe d172 (coe v0)))) (coe d174 (coe v0))
...
du290 ::
  T270 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du290 v0 = coe du260 (coe d280 (coe v0))
name292
...
du292 ::
  T270 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du292 v0 = coe du262 (coe d280 (coe v0))
name294
...
du318 :: T270 -> T44
du318 v0
  = coe C1575 (coe d234 (coe d280 (coe v0))) (coe d282 (coe v0))
name322
...
du428 v0
  = coe
      C5945 (coe d348 (coe d398 (coe v0))) (coe d400 (coe v0))
      (coe d402 (coe v0))
name432
...
du432 v0
  = coe
      C1575 (coe d80 (coe d126 (coe d348 (coe d398 (coe v0)))))
      (coe d400 (coe v0))
...
du474 :: T454 -> T44
du474 v0 = coe C1575 (coe d464 (coe v0)) (coe du470 (coe v0))
...
du492 :: MAlonzo.Code.Agda.Primitive.T14 -> T454 -> T222
du492 v0 v1
  = coe
      C7263 (d464 (coe v1)) (d466 (coe v1))
      (coe
...
du494 :: MAlonzo.Code.Agda.Primitive.T14 -> T454 -> T270
du494 v0 v1
  = coe
      C10615 (coe du492 (coe v0) (coe v1)) (coe du470 (coe v1))
      (coe du472 (coe v1))
name498
...
du500 ::
  ...
  T454 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du500 v0 v1 = coe du260 (coe du492 (coe v0) (coe v1))
name502
...
du502 ::
  ...
  T454 ->
  AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny
du502 v0 v1 = coe du262 (coe du492 (coe v0) (coe v1))
