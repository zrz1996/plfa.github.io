...
du36 v0 v1 v2 v3 v4 v5 v6
  = coe
      v1 (coe MAlonzo.Code.Function.Base.du74 (coe v0) (coe v2)) v3 v4 v5
      v6
...
d56 v0 v1 v2 v3 v4 v5 v6 = du56 v6
du56 ::
  ((AgdaAny -> ()) ->
   AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny) ->
  MAlonzo.Code.Agda.Builtin.Sigma.T14
du56 v0
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.C32 (coe du46 erased (coe v0))
      (coe du36 erased (coe v0))
...
du234 :: MAlonzo.Code.Agda.Primitive.T14 -> AgdaAny
du234 v0
...
du746 v0 v1 v2 v3
  = coe
      ...
      (\ v4 v5 -> coe MAlonzo.Code.Relation.Nullary.du60 (coe v0) v4)
      (coe v1 v2 v3)
