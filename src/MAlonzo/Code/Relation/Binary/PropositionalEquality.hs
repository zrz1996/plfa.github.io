...
du68 v0
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C1575 (coe du66) (coe v0)
...
du72
  = coe
      MAlonzo.Code.Relation.Binary.Structures.C2159 (coe du66)
...
du112 v0 v1
  = coe
      MAlonzo.Code.Function.Equality.C769 (coe v1)
      (coe
         (\ v2 v3 v4 ->
            coe
...
d184 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> ()
d184 = erased
