...
du24
  = coe
      ...
      (coe (\ v0 -> MAlonzo.Code.Data.Bool.Base.d22)) (coe du16)
...
du42 v0
  = case coe v0 of
      MAlonzo.Code.Relation.Nullary.C46 v1 v2
        -> if coe v1
             then let v3 = coe MAlonzo.Code.Agda.Builtin.Unit.C8 in
                  coe (\ v4 -> v3)
      ...
      MAlonzo.Code.Relation.Nullary.C46 v1 v2
        -> if coe v1
             then coe
                    ...
                    (coe MAlonzo.Code.Function.Base.du90)
                    (coe MAlonzo.Code.Relation.Nullary.Reflects.du20 (coe v2))
             else (let v3 = coe MAlonzo.Code.Agda.Builtin.Unit.C8 in
                   coe (\ v4 -> v3))
      _ -> MAlonzo.RTE.mazUnreachableError
