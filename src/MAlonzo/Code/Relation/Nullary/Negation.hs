...
du26 :: MAlonzo.Code.Agda.Primitive.T14 -> AgdaAny
...
d106 :: MAlonzo.Code.Agda.Primitive.T14 -> () -> ()
d106 = erased
...
du140
  = coe
      ...
      (coe (\ v0 v1 v2 v3 -> coe du26 (coe ()))) erased
        ...
        -> if coe v4
             then case coe v5 of
                    ...
                    (coe
                       ...
                       (coe
                          MAlonzo.Code.Function.Base.du184
...
d250 :: MAlonzo.Code.Agda.Primitive.T14 -> ()
d250 = erased
name258 = "Relation.Nullary.Negation.Double-Negation-Elimination"
d258 :: MAlonzo.Code.Agda.Primitive.T14 -> ()
d258 = erased
