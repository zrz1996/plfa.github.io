...
<a id="916" class="Keyword">open</a> <a id="921" class="Keyword">import</a> <a id="928" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}" class="Module">plfa.part1.Relations</a> <a id="949" class="Keyword">using</a> <a id="955" class="Symbol">(</a><a id="956" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18383" class="Datatype Operator">_&lt;_</a><a id="959" class="Symbol">;</a> <a id="961" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18410" class="InductiveConstructor">z&lt;s</a><a id="964" class="Symbol">;</a> <a id="966" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18467" class="InductiveConstructor">s&lt;s</a><a id="969" class="Symbol">;</a> <a id="971" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21136" class="InductiveConstructor">zero</a><a id="975" class="Symbol">;</a> <a id="977" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21178" class="InductiveConstructor">suc</a><a id="980" class="Symbol">;</a> <a id="982" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21081" class="Datatype">even</a><a id="986" class="Symbol">;</a> <a id="988" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21101" class="Datatype">odd</a><a id="991" class="Symbol">)</a>
</pre>{% endraw %}
## Naturals
...
{% raw %}<pre class="Agda"><a id="1814" class="Keyword">data</a> <a id="Bin"></a><a id="1819" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a> <a id="1823" class="Symbol">:</a> <a id="1825" class="PrimitiveType">Set</a> <a id="1829" class="Keyword">where</a>
  <a id="Bin.nil"></a><a id="1837" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1837" class="InductiveConstructor">nil</a> <a id="1841" class="Symbol">:</a> <a id="1843" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a>
  <a id="Bin.x0_"></a><a id="1849" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1849" class="InductiveConstructor Operator">x0_</a> <a id="1853" class="Symbol">:</a> <a id="1855" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a> <a id="1859" class="Symbol">→</a> <a id="1861" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a>
  <a id="Bin.x1_"></a><a id="1867" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1867" class="InductiveConstructor Operator">x1_</a> <a id="1871" class="Symbol">:</a> <a id="1873" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a> <a id="1877" class="Symbol">→</a> <a id="1879" href="{% endraw %}{{ site.baseurl }}{% link out/puc/2019/Assignment1.md %}{% raw %}#1819" class="Datatype">Bin</a>
