...
<a id="916" class="Keyword">open</a> <a id="921" class="Keyword">import</a> <a id="928" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}" class="Module">plfa.part1.Relations</a> <a id="949" class="Keyword">using</a> <a id="955" class="Symbol">(</a><a id="956" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18905" class="Datatype Operator">_&lt;_</a><a id="959" class="Symbol">;</a> <a id="961" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18932" class="InductiveConstructor">z&lt;s</a><a id="964" class="Symbol">;</a> <a id="966" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#18989" class="InductiveConstructor">s&lt;s</a><a id="969" class="Symbol">;</a> <a id="971" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21658" class="InductiveConstructor">zero</a><a id="975" class="Symbol">;</a> <a id="977" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21700" class="InductiveConstructor">suc</a><a id="980" class="Symbol">;</a> <a id="982" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21603" class="Datatype">even</a><a id="986" class="Symbol">;</a> <a id="988" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Relations.md %}{% raw %}#21623" class="Datatype">odd</a><a id="991" class="Symbol">)</a>
</pre>{% endraw %}
## Naturals
